...
def main() -> None:
    ...
    pred_path = args.output_root / "predictions" / args.model_id / f"{args.dataset_name}_clean.csv"
    metric_path = args.output_root / "evaluation" / f"{args.model_id}_{args.dataset_name}_clean.csv"
